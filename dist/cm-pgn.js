import {Chess as $iN3Kb$Chess} from "chess.js";
 ...
 * Repository: https://github.com/shaack/cm-pgn
 * License: MIT, see file 'LICENSE'
 */ const $b5b46aa459ee90e8$export$de435b1ae0c975f3 = {
...
class $b5b46aa459ee90e8$export$8b251419efc915eb {
 ...
 * http://pegjs.org/
 */ "use strict";
function $d8da7098798a3265$var$peg$subclass(child, parent) {
    function ctor() {
...
function $d8da7098798a3265$var$peg$SyntaxError(message, expected, found, location) {
    this.message = message;
    this.expected = expected;
    this.found = found;
    this.location = location;
    this.name = "SyntaxError";
    if (typeof Error.captureStackTrace === "function") Error.captureStackTrace(this, $d8da7098798a3265$var$peg$SyntaxError);
}
$d8da7098798a3265$var$peg$subclass($d8da7098798a3265$var$peg$SyntaxError, Error);
$d8da7098798a3265$var$peg$SyntaxError.buildMessage = function(expected, found) {
...
function $d8da7098798a3265$var$peg$parse(input, options) {
    ...
    function peg$buildSimpleError(message, location) {
        return new $d8da7098798a3265$var$peg$SyntaxError(message, null, null, location);
    }
    function peg$buildStructuredError(expected, found, location) {
        return new $d8da7098798a3265$var$peg$SyntaxError($d8da7098798a3265$var$peg$SyntaxError.buildMessage(expected, found), expected, found, location);
    }
...
class $d8da7098798a3265$export$3cdeb556c0405180 {
    static parse(history, options) {
        return $d8da7098798a3265$var$peg$parse(history, options);
    }
}



function $fd2bc6ae51ee1b80$var$IllegalMoveException(fen, notation) {
    this.fen = fen;
...
class $fd2bc6ae51ee1b80$export$84202caead5689ba {
    constructor(historyString = null, setUpFen = null, sloppy = false){
        if (!historyString) this.clear();
        else {
            const parsedMoves = (0, $d8da7098798a3265$export$3cdeb556c0405180).parse(historyString.replace(/\s\s+/g, " ").replace(/\n/g, " "));
    ...
    traverse(parsedMoves, fen, parent = null, ply = 1, sloppy = false) {
        const chess = fen ? new (0, $iN3Kb$Chess)(fen) : new (0, $iN3Kb$Chess)() // chess.js must be included in HTML
        ;
        const moves = [];
        ...
        for (let parsedMove of parsedMoves){
            if (parsedMove.notation) {
                ...
                if (move) {
                    if (previousMove) {
                        if (!move.previous) move.previous = previousMove;
                        if (!previousMove.next) previousMove.next = move;
                    ...
                    moves.push(move);
                    previousMove = move;
                } else throw new $fd2bc6ae51ee1b80$var$IllegalMoveException(chess.fen(), notation);
            }
            ply++;
        }
        return moves;
    ...
    fillMoveFromChessState(move, chess) {
        ...
        if (chess.isGameOver()) {
            move.gameOver = true;
            if (chess.isDraw()) move.inDraw = true;
            if (chess.isStalemate()) move.inStalemate = true;
            if (chess.isInsufficientMaterial()) move.insufficientMaterial = true;
            if (chess.isThreefoldRepetition()) move.inThreefoldRepetition = true;
            if (chess.isCheckmate()) move.inCheckmate = true;
        }
        if (chess.isCheck()) move.inCheck = true;
    }
    /**
     * @param move
     ...
     */ validateMove(notation, previous = null, sloppy = true) {
        ...
        const chess = new (0, $iN3Kb$Chess)(this.setUpFen ? this.setUpFen : undefined);
        if (previous) {
        ...
        if (move) this.fillMoveFromChessState(move, chess);
        return move;
    }
    ...
    render(renderComments = true, renderNags = true) {
        const renderVariation = (variation, needReminder = false)=>{
            ...
            for (let move of variation){
                if (move.ply % 2 === 1) result += Math.floor(move.ply / 2) + 1 + ". ";
                else if (result.length === 0 || needReminder) result += move.ply / 2 + "... ";
                needReminder = false;
                if (renderNags && move.nag) result += "$" + move.nag + " ";
                ...
                if (move.variations.length > 0) for (let variation of move.variations){
...
class $b95efacd4e4bd1dc$export$5fdd9ba0e9cda5d1 {
    constructor(pgnString = "", props = {}){
        ...
        this.header = new (0, $b5b46aa459ee90e8$export$8b251419efc915eb)(headerString);
        if (this.header.tags[(0, $b5b46aa459ee90e8$export$de435b1ae0c975f3).SetUp] === "1" && this.header.tags[(0, $b5b46aa459ee90e8$export$de435b1ae0c975f3).FEN]) this.history = new (0, $fd2bc6ae51ee1b80$export$84202caead5689ba)(historyString, this.header.tags[(0, $b5b46aa459ee90e8$export$de435b1ae0c975f3).FEN], sloppy);
        else this.history = new (0, $fd2bc6ae51ee1b80$export$84202caead5689ba)(historyString, null, sloppy);
    }
    wrap(str, maxLength) {
        ...
        for(let i = 0; i < words.length; i++){
            const word = words[i];
            if (line.length + word.length < maxLength) line += word + " ";
            else {
    ...
    render(renderHeader = true, renderComments = true, renderNags = true) {
        ...
        if (this.header.tags[(0, $b5b46aa459ee90e8$export$de435b1ae0c975f3).Result]) history += " " + this.header.tags[(0, $b5b46aa459ee90e8$export$de435b1ae0c975f3).Result];
        return header + this.wrap(history, 80);
    }
}


export {$b95efacd4e4bd1dc$export$5fdd9ba0e9cda5d1 as Pgn};
//# sourceMappingURL=cm-pgn.js.map
